...
public:
    InternetDownload(HWND parentHwnd, const tstring& userAgent, const tstring& url, CancelToken cancelToken, boostOrStd::function<void(int)> progressFunction = NULL);
...
private:
    ...
    boostOrStd::function<void(int)> m_progressFunction;
